...
import { getOneProject, AddTask } from "../api/API";
...
const TaskApp = () => {
  ...
  return (
    <Container>
                        ...
                        {(provided: any, snapshot: any) => (
                          ...
                          >
                            ...
                            <TaskDetails>
                              ...
                              <TaskContent>
                                <TaskLabel>Assigned to:</TaskLabel>
                                <TaskAssignee>John Doe</TaskAssignee>
                              </TaskContent>
      ...
      {/* {toggle && <createTask toggle={toggle} setToggle={setToggle} />} */}
    </Container>
  );
};
